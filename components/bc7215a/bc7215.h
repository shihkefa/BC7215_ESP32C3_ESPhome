...
{
public:
    // Call only while RX is stopped and stale UART bytes have been drained.
    void resetReceiveState();
    void abortCommand();
    bool receiveIncomplete() const { return bc7215Status.pktStarted; }
    bool io_error = false; // Latched BUSY timeout; reboot to retry.
	/**
